...
public class Create_operators {
	...
	public static void main (String [] args) { 
		...
		for (int i =1; i<100; i++){
			...
			resultJson.put("name", "ur_operator" + i);
			...
			System.out.print("' http://srv2-gf-lisdv01.net.billing.ru/OAPI/v1/lis/dictionaries/logicalResources/operators");
