...
public class Create_SIMCardStates {
	...
	public static void main (String [] args) { 
		...
		for (int i =1; i<100; i++){
			...
			resultJson.put("name", "dv_SIMCardClasses" + i);
			...
			System.out.print("' http://srv2-gf-lisdv01.net.billing.ru/OAPI/v1/lis/dictionaries/logicalResources/SIMCardClasses");
